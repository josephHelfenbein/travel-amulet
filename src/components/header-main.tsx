    ...
    return (
        ...
        <div className="container-fluid">
            <a className="navbar-brand p-2" href="#">App Name</a>
                ...
                {login &&
                    <form className='d-flex'>
                        <svg id='profileDropdown' data-bs-toggle="dropdown" aria-expanded="false" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill='black' viewBox="0 -960 960 960">
